  ...
  return (
    <footer className="w-full bg-[#124734] pt-16 pb-8 border-t border-gray-100">
      <div className="max-w-6xl mx-auto px-6">
        ...
        {/* Links Section */}
        <div className="flex flex-col space-y-4 text-white md:w-1/3">
            <h3 className="text-xl font-bold text-[#F5C27B]">Links</h3>
        ...
        {/* Contact Section */}
        <div className="flex flex-col space-y-4 text-white md:w-1/3">
            <h3 className="text-xl font-bold text-[#F5C27B]">Contact Us</h3>
            <ul className="space-y-2 font-medium">
